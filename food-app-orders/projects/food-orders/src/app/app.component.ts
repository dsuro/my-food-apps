...
import { CutomerOrdersComponents} from './customer-orders/cutomer-orders-registry';
...
export class AppComponent {
  ...
  loadComponent(){
    ...
    this.componentRef=this.webCompRef.createComponent<any>(CutomerOrdersComponents[this.appDetails?.key]);
    if(this.data)
    {
