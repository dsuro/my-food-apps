...
import { InventoryComponents } from './inventory/inventory-registry';
...
export class AppComponent {
  ...
  loadComponent(){
    ...
    this.componentRef=this.webCompRef.createComponent<any>(InventoryComponents[this.appDetails?.key]);
    if(this.data)
    {
